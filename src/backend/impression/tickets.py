...
Description:
    Impression automatique des tickets de commande récapitulatif et de
    cuisine après validation d'une commande.
...
from src.backend.impression.ressources import charger_logo
