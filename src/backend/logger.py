...
MODIFICATION_MODE_ALLEGE = "MODIFICATION_MODE_ALLEGE"
EXPORT_RAPPORT_STATS = "EXPORT_RAPPORT_STATS"
...
_CATEGORIES: dict = {
    ...
    MODIFICATION_MODE_ALLEGE: "parametres",
    EXPORT_RAPPORT_STATS: "commande",
