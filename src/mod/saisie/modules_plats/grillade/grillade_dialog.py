...
# propres à la grillade (compteur de viande) restent définis ici.

_DIALOG_STYLE = dialogues_plats.DIALOG_STYLE
_BTN_STYLE = dialogues_plats.BTN_STYLE
_VALIDATE_BTN_STYLE = dialogues_plats.VALIDATE_BTN_STYLE
...
_TITLE_STYLE = dialogues_plats.TITLE_STYLE
_SECTION_STYLE = dialogues_plats.SECTION_STYLE
...
_PRIX_TOTAL_STYLE = dialogues_plats.PRIX_TOTAL_STYLE
_WARNING_STYLE = dialogues_plats.WARNING_STYLE
_MAX_PORTIONS_STYLE = "font-size: 12px; color: #a8d08d; padding: 2px 0;"

_ACCOMP_BTN_STYLE = dialogues_plats.style_bouton_toggle(
    font_size=13, padding="6px 16px", min_height=32
)
