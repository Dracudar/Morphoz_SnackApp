...
_INGREDIENT_BTN_STYLE = dialogues_plats.style_bouton_toggle(
...
_CATEGORY_STYLE = dialogues_plats.CATEGORY_STYLE
_PRIX_TOTAL_STYLE = dialogues_plats.PRIX_TOTAL_STYLE
_WARNING_STYLE = dialogues_plats.WARNING_STYLE

SUPPLEMENT_VIANDE = dialogues_plats.SUPPLEMENT_VIANDE
