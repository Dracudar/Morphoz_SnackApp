...
# -*- coding: utf-8 -*-
"""
formulaire_edition.py

Description:
    Construction du panneau droit du module Stock : état vide, formulaire de
    détail/édition d'un article (catégorie, nom, suivi quantité, stock réel,
    statut), ajout et suppression d'articles.
...
class _FormulaireEditionMixin:
    """Méthodes de construction du panneau de détail, mélangées dans StockModule."""
    ...
    def _on_add_item_clicked(self) -> None:
        ...
        new_node: Dict = {"OutOfStock": False}
